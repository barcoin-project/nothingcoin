...
unlocked to sign the Nothingcoin-Qt.app bundle.
...
allowing somebody to distribute a Nothingcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the nothingcoin-qt.exe file inside the installer had not been tampered with.
